    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favorite_graphic_titles', models.ManyToManyField(blank=True, to='main.graphictitle')),
                ('favorite_text_titles', models.ManyToManyField(blank=True, to='main.texttitle')),
