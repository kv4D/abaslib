    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favorite_graphic_titles', models.ManyToManyField(blank=True, to='titles.graphictitle')),
                ('favorite_text_titles', models.ManyToManyField(blank=True, to='titles.texttitle')),
